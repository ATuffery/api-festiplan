...
class AuthServiceTest extends TestCase {
    ...
    public function testAuthentification() {
        try {
            ...
            $result = AuthService::authentification($this->pdo, "admin", "admin");
    ...
    public function testAuthentificationWrongPassword() {
        try {
            ...
            $result = AuthService::authentification($this->pdo, "admin", "wrongpassword");
    ...
    public function testAuthentificationWrongLogin() {
        try {
            ...
            $result = AuthService::authentification($this->pdo, "wronglogin", "admin");
            // Then on reçoit une array vide
            $this->assertEmpty($result);
    ...
    public function testAddApiKey() {
        try {
            ...
            $user = AuthService::authentification($this->pdo, "ouiTest", "ouiTest");
